	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					<Td><input type="password" name="p" class="form-control" placeholder="Registration Number" required/></td>
				</tr>
				...
				<tr>
					...
					<Td>
					<select style="width:100px;float:left" name="yy" class="form-control">
					...
					<select style="width:100px;float:left" name="mm" class="form-control">
					...
					<select style="width:100px;float:left" name="dd" class="form-control">
