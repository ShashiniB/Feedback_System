                    ...
                    <ul class="nav" id="side-menu">
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
								 ...
								 <li>
                                    <a href="dashboard.php?info=registration"><i class="fa fa-eye"></i> Add Student</a>
                                </li> 
										 <li>
						...
						<li>
                            <a href="#"><i class="fa fa-user fa-fw"></i>Lecturer<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
								 <li>
                                    <a href="dashboard.php?info=show_faculty"><i class="fa fa-eye"></i> Manage Lecturer</a>
                                </li>                           
							</ul>
                            <!-- /.nav-second-level -->
                        </li>
